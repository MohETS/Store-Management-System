...
-- Insert store
INSERT INTO public.store(id, name) VALUES (1, 'HQ TEST');
INSERT INTO public.store(id, name) VALUES (2, 'Store 1 TEST');
INSERT INTO public.store(id, name) VALUES (3, 'Store 2 TEST');

-- Insert store accounts
INSERT INTO public.store_account(username, password) VALUES ('test.store', 'password' );

-- Insert products
INSERT INTO public.product(id, name, category, quantity, price) VALUES (1, 'Sifu TEST', 'Games', 999, 50);
INSERT INTO public.product(id, name, category, quantity, price) VALUES (2, 'Sony XM4 TEST', 'Sound', 999, 250);
INSERT INTO public.product(id, name, category, quantity, price) VALUES (3, 'Playstation 5 TEST', 'Games', 999, 500);
INSERT INTO public.product(id, name, category, quantity, price) VALUES (4, 'Fl Studio TEST', 'Software', 999, 250);
INSERT INTO public.product(id, name, category, quantity, price) VALUES (5, 'NVIDIA GeForce RTX 3080 Ti TEST', 'Hardware', 999, 900);
...
-- Insert Sale
INSERT INTO public.sale(total_price) VALUES (500);
INSERT INTO public.sale(total_price) VALUES (50);
INSERT INTO public.sale(total_price) VALUES (900);


-- Insert Sale-Item
INSERT INTO public.sale_item(sale_id, product_id, quantity, product_price) VALUES ( 1, 1,1,50);
INSERT INTO public.sale_item(sale_id, product_id, quantity, product_price) VALUES ( 2, 4,2,250);
INSERT INTO public.sale_item(sale_id, product_id, quantity, product_price) VALUES ( 3, 5,1,900);